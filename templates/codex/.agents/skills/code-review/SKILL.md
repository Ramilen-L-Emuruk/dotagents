...
2. Trace affected behavior through callers, data boundaries, error paths, and tests. Prefer evidence from the implementation over stale documentation.
...
5. Do not turn style preferences into defects. If no actionable issue remains, say so and name residual verification limits.
